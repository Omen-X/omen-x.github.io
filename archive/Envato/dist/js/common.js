...
$(document).ready(function () {
	...
	if (!version) {
		...
		(function () {
			...
			var updateTimer = function updateTimer() {
				...
				var tHours = document.querySelector('.timer__hours .timer__value');
				var tMins = document.querySelector('.timer__minutes .timer__value');
				var tSecs = document.querySelector('.timer__seconds .timer__value');
			...
			deadline = 'December 31 2045 23:59:59 GMT+03:00';
	...
	function speakerMargin() {
		var padding = parseInt($('.speakers .col-md-4').css('width'), 10) - parseInt($('.speaker').css('width'), 10);
	...
	var welcome = $('.main-info-wrap').waypoint(function () {
		$('.advantages__item').removeClass('rotate');
	});

	var sponsorLogos = $('.sponsor').waypoint(function () {
		$('.sponsor__logo').removeClass('transform opac');
	}, {
		offset: '30%'
	});

	var map = $('.map-wrap').waypoint(function () {
